...
export const Button = ({
  ...
  return (
    <button
      className={cn(
        "relative overflow-hidden flex place-content-center place-items-center gap-2 rounded-md px-4 py-2 font-main text-white uppercase shadow-2xl inset-shadow-xs shadow-taupe-950/10 inset-shadow-taupe-100/10 transition-[colors,filter]",
