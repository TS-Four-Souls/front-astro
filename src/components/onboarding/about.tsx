  ...
  return (
    <>
      ...
      <Button
        ...
        theme="onSpace"
      />
      <div className="flex max-h-[calc(100vh-640px)] min-h-120 max-w-3xl flex-col gap-8 overflow-auto rounded-lg border-2 border-space-400 bg-space p-8 pb-16 select-text">
        ...
        <ul className="flex list-inside list-disc flex-col gap-4 leading-relaxed">
          ...
          <li>
            ...
            <img src="/ui/contact.png" className="inline-block size-8" /> icon
            in the bottom-right corner. While in game, you need to open the main
            menu (by pressing{" "}
            <img
              src="/input-prompts/keyboard_escape_outline.svg"
              title="Escape"
