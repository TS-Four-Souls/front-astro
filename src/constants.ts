import { ThreeDMode, ZoomResolutionPreset } from "./components/board/contexts/user-settings-context";

/** Allow the user to draw treasures and loot cards from the decks */
export const CHEAT_MODE: boolean = true;

export const DEFAULT_ZOOM_RESOLUTION_PRESET: ZoomResolutionPreset = ZoomResolutionPreset.LOW;
